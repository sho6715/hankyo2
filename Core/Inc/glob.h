...
#define GOAL_MAP_X_DEF					( 2 )//2				// ă´ăźăŤăŽXĺşçťć°?źć¨Şćšĺďź? [ĺşçť]17
#define GOAL_MAP_Y_DEF					( 12 )//11				// ă´ăźăŤăŽYĺşçťć°?źç¸Śćšĺďź? [ĺşçť]13
...
#define TIRE_D						( 0.01257f )	//ć¨ĺŽĺ¤								// ăżă¤ă¤ç´ĺž? [mm]
