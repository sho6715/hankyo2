...
/* ============== */
	...
	const stGAIN f_StGainData[PARAM_MOVE_SPEED_MAX] = {
		...
		/* 超低速(PARAM_VERY_SLOW) */
			...
			{ 35.0,2.0,0.1,	95.0,6.0,0.2,	0.45,0.0,	0.65,0.2,},
		/* 低速(PARAM_SLOW) */
			///速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 35.0,2.0,0.1,	95.0,6.0,0.2,	0.45,0.0,	0.65,0.2,},
		/* 通常(PARAM_NORMAL) */
	...
	const stGAIN f_SlaGainData[PARAM_MOVE_SPEED_MAX] = {
		...
		/* 超低速(PARAM_VERY_SLOW) *///吸引なし　300
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 35.0,2.0,0.1,	95.0,0.5,0.5,	0.0,0.0,	0.65,0.2,},
		//{ 35.0,2.0,0.1,	95.0,6.0,0.2,	0.45,0.0,	0.65,0.2,},
		/* 低速(PARAM_SLOW) *///吸引あり300
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 35.0,2.0,0.1,	95.0,1.2,0.2,	0.45,0.0,	0.65,0.2,},
		/* 通常(PARAM_NORMAL)*///吸引あり600
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 35.0,2.0,0.1,	95.0,1.2,1.0,	0.45,0.0,	0.65,0.2,},
		/* 高速(PARAM_FAST)*/
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
