...
/* ============ */
	...
	const stSPEED f_StSpeedData[PARAM_MOVE_SPEED_MAX] = {
		...
		{ 1.8,			1.8,		0,				0,				},		// ?��ʏ�(PARAM_NORMAL)
		{ 2.5,			2.5,		0,				0,				},		// ?��?��?��?��(PARAM_FAST)
		{ 4.0,			4.0,		0,				0,				},		// ?��?��?��?��?��?��(PARAM_VERY_FAST)
	};
	...
	const stSPEED f_TurnSpeedData[PARAM_MOVE_SPEED_MAX] = {
		...
		//	?��?��?��?��?��x		?��?��?��?��?��x		?��p?��?��?��?��?��x		?��p?��?��?��?��?��x
		{ 0,			0,			22.2*PI,		10.0*PI,		},		// ?��?��?��ᑬ(PARAM_VERY_SLOW)
		{ 0,			0,			22.2*PI,		10.0*PI,		},		// ?��ᑬ(PARAM_SLOW)
		{ 0,			0,			22.2*PI,		10.0*PI,		},		// ?��ʏ�(PARAM_NORMAL)
		{ 0,			0,			22.2*PI,		10.0*PI,		},		// ?��?��?��?��(PARAM_FAST)
		{ 0,			0,			22.2*PI,		10.0*PI,		},		// ?��?��?��?��?��?��(PARAM_VERY_FAST)
	};
