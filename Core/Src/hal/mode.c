...
enMODE		en_Mode;		//迴ｾ蝨ｨ縺ｮ繝｢繝ｼ???ｿｽ?ｿｽ??ｿｽ?ｿｽ?
...
void MODE_inc( void )
{
	en_Mode++;		// 繝｢繝ｼ繝峨ｒ???ｿｽ?ｿｽ??ｿｽ?ｿｽ????ｿｽ?ｿｽ??ｿｽ?ｿｽ?

	/* 譛螟ｧ蛟､繝√ぉ???ｿｽ?ｿｽ??ｿｽ?ｿｽ?繧ｯ */
	if( MODE_MAX == en_Mode ){
		en_Mode = MODE_0;
	}
...
//			LL_TIM_EnableCounter(TIM4);
		...
		case MODE_4:
			...
			MOT_setSuraStaSpeed( SEARCH_SPEED );							// 繧ｹ繝ｩ繝ｭ繝ｼ???ｿｽ?ｿｽ??ｿｽ?ｿｽ?髢句ｧ矩溷ｺｦ險ｭ???ｿｽ?ｿｽ??ｿｽ?ｿｽ?
			PARAM_setSpeedType( PARAM_ST,   PARAM_VERY_SLOW );							// [逶ｴ騾ｲ] 騾溷ｺｦ譎ｮ???ｿｽ?ｿｽ??ｿｽ?ｿｽ?
			PARAM_setSpeedType( PARAM_TRUN, PARAM_VERY_SLOW );							// [譌句屓] 騾溷ｺｦ譎ｮ???ｿｽ?ｿｽ??ｿｽ?ｿｽ?
			PARAM_setSpeedType( PARAM_SLA,  PARAM_VERY_SLOW );							// [繧ｹ繝ｩ] 騾溷ｺｦ譎ｮ???ｿｽ?ｿｽ??ｿｽ?ｿｽ?
			SetLED(0x00);
			LL_mDelay(500);
			CTRL_clrNowData();
			CTRL_clrData();
...
void MODE_exe_m1( void )
{
	...
	switch( en_Mode ){
		...
		case MODE_5:
			SetLED(0x0e);
			MAP_setPos( 0, 0, NORTH );												// ???ｿｽ?ｿｽ??ｿｽ?ｿｽX???ｿｽ?ｿｽ??ｿｽ?ｿｽ^???ｿｽ?ｿｽ??ｿｽ?ｿｽ[???ｿｽ?ｿｽ??ｿｽ?ｿｽg???ｿｽ?ｿｽ??ｿｽ?ｿｽﾊ置
			MAP_Goalsize(1);
			MAP_makeContourMap_run( GOAL_MAP_X_def, GOAL_MAP_Y_def, BEST_WAY );					// ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ}???ｿｽ?ｿｽ??ｿｽ?ｿｽb???ｿｽ?ｿｽ??ｿｽ?ｿｽv???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ
			MAP_makeCmdList( 0, 0, NORTH, GOAL_MAP_X_def, GOAL_MAP_Y_def, &en_endDir2 );		// ???ｿｽ?ｿｽ??ｿｽ?ｿｽh???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽC???ｿｽ?ｿｽ??ｿｽ?ｿｽu???ｿｽ?ｿｽ??ｿｽ?ｿｽR???ｿｽ?ｿｽ??ｿｽ?ｿｽ}???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽh???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ
			MAP_makeSuraCmdList();													// ???ｿｽ?ｿｽ??ｿｽ?ｿｽX???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ[???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽR???ｿｽ?ｿｽ??ｿｽ?ｿｽ}???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽh???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ
			MAP_makeSkewCmdList();													// ???ｿｽ?ｿｽ??ｿｽ?ｿｽﾎめコ???ｿｽ?ｿｽ??ｿｽ?ｿｽ}???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽh???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ
			MAP_showCmdLog();
			break;
...
void MODE_exe_m3( void )
{
	...
	switch( en_Mode ){
		...
		case MODE_0:
			...
			LL_mDelay(500);
			Set_DutyTIM8(600);
			LL_mDelay(2000);													// ???ｿｽ?ｿｽ??ｿｽ?ｿｽﾎめコ???ｿｽ?ｿｽ??ｿｽ?ｿｽ}???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽh???ｿｽ?ｿｽ??ｿｽ?ｿｽ???ｿｽ?ｿｽ??ｿｽ?ｿｽ
...
bool MODE_setWaitCheck(void){
	...
	if( TRUE == MODE_DistRightCheck() ){	// 蜿ｳ???ｿｽ?ｿｽ??ｿｽ?ｿｽ?縺第､懃衍
		SetLED(0x08);
	}
	if( TRUE == MODE_DistLeftCheck() ){		// 蟾ｦ???ｿｽ?ｿｽ??ｿｽ?ｿｽ?縺第､懃衍
		SetLED(0x02);
	}
