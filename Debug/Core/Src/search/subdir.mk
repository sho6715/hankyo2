...
Core/Src/search/%.o Core/Src/search/%.su: ../Core/Src/search/%.c Core/Src/search/subdir.mk
...
clean-Core-2f-Src-2f-search:
	-$(RM) ./Core/Src/search/map_cmd.d ./Core/Src/search/map_cmd.o ./Core/Src/search/map_cmd.su ./Core/Src/search/map_flash.d ./Core/Src/search/map_flash.o ./Core/Src/search/map_flash.su ./Core/Src/search/search.d ./Core/Src/search/search.o ./Core/Src/search/search.su
